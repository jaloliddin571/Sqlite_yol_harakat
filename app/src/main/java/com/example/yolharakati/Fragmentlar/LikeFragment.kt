...
import com.example.yolharakati.Adapters.MyRvAdapter
...
class LikeFragment : Fragment(), MyRvAdapter.RvClick {
    ...
    override fun onCreateView(
        ...
        binding.likeQaytish.setOnClickListener {
    ...
    override fun editClick(label: Label) {
        ...
        findNavController().navigate(R.id.addFragment, bundleOf("key" to label))
    }
